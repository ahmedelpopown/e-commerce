...
<body class="bg-gray-50 antialiased" style="display: flex; flex-direction: column; flex-wrap:wrap ; min-height: 100vh; align-items: stretch; justify-content: space-between;">
    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:p-8">
            ...
            <nav class="border-t py-4">
                <ul class="flex items-center gap-8" style="gap: 2rem; justify-content: flex-start;">
                    <li>
    ...
    <!-- Footer -->
    <footer class="bg-[#000648] text-white mt-16" style="background-color: #000648; ">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 "
            style="display: flex; flex-direction: column; flex-wrap: wrap; justify-content: space-around; padding: 2rem; ">
            <div class="  grid-cols-1 md:grid-cols-4 gap-8 flex content-around p-16" style="display: flex; justify-content: space-around; padding: 4rem;">
                <div>
            ...
            <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400 p-8">
