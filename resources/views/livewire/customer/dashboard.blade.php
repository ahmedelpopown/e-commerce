<div class="bg-gray-50 py-8">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8"  style="margin-top: 1rem; display: flex; flex-direction: row; flex-wrap: wrap; align-items: center; justify-content: space-between;">
            {{-- quick actions --}}
            <div class="lg:col-span-1" style="width: 30%;">
                <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            {{-- Recent Orders --}}
            <div class="lg:col-span-2" style="width: 60%;">
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    @else
                        <div class="text-center py-8">
                            <svg class="mx-auto w-5 h-5 text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                            </svg>
